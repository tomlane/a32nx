        ...
        return (
            <svg class="nd-svg" viewBox="0 0 768 768">
                ...
                <g visibility={this.infoContainerVisible.map((it) => (it ? 'inherit' : 'hidden'))}>
                    ...
                    <text x={709} y={639} fontSize={22} fill={this.upperBorderFill}>{this.upperBorderText}</text>

                    <rect x={700} y={619} width={54} height={24} strokeWidth={3} stroke="rgb(255,255,0)" fill="transparent" />

                    <text x={709} y={663} fontSize={23} fill={this.lowerBorderFill}>{this.lowerBorderText}</text>

                    <rect x={700} y={643} width={54} height={24} strokeWidth={3} stroke="rgb(255,255,0)" fill="transparent" />
                </g>
            </svg>
        );
    }
