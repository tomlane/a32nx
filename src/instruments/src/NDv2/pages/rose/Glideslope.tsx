...
export class GlideSlope extends DisplayComponent<GlideSlopeProps> {
    ...
    render(): VNode | null {
        return (
            <>
                <Layer x={750} y={384}>
                    <circle cx={0} cy={-128} r={4} strokeWidth={2.5} class="White" />
                    <circle cx={0} cy={-64} r={4} strokeWidth={2.5} class="White" />
                    <line x1={-12} x2={12} y1={0} y2={0} strokeWidth={5} class="Yellow" />
                    <circle cx={0} cy={64} r={4} strokeWidth={2.5} class="White" />
                    <circle cx={0} cy={128} r={4} strokeWidth={2.5} class="White" />
                </Layer>
